...
namespace dlib
{
    ...
    template <
        typename T
        >
    class array_dp : public array<T>
    {
    	array_dp(array<T>& a)
    	{
    		this->array_elements = a.array_elements;
			this->array_size = a.array_size;
			this->max_array_size = a.max_array_size;
			this->pos = a.pos;
			this->last_pos = a.last_pos;
			this->_at_start = a._at_start;
    	}
        ~array_dp ()
		{
